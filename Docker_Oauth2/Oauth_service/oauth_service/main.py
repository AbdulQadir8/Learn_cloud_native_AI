...
from oauth_service.utils import create_access_token, decoded_access_token
...
def decoding_token(access_token: str):
    ...
    """
    try:
        decoded_token_data = decoded_access_token(access_token)
...
def read_users_me(token: str):
    try:
        user_token_data = decoded_access_token(token)
